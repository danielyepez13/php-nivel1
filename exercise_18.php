...
<body>
    <?php
        ...
        //Esta línea de código genera un error, ya que la apalabra reservada print solo acepta un parámetro
        //print 'Esta ', 'Cadena de caracteres ', 'puede contener ', 'multiples parámetros';
    ?>
